            ...
            <div className="relative z-10 flex justify-center pt-15 md:19">
                <div className="flex flex-col gap-8">
                    ...
                    <div className="hero-item flex justify-center">
                        <a href="/menu-la-mesa.pdf" target='_blank' download="menu-la-mesa.pdf" rel="noopener noreferrer" className="w-30 h-10 md:w-40 md:h-15 border rounded-3xl border-dorado text-crema hover:bg-white/10 hover:cursor-pointer pl-4 pt-1.5 tracking-wider md:pt-4 md:pl-8">VER MENÚ</a>
                    </div>
                    <div className='flex justify-center'>
